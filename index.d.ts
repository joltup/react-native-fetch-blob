...
export interface Dirs {
  DocumentDir: string;
  CacheDir: string;
  PictureDir: string; // Android Only
  MusicDir: string; // Android Only
  MovieDir: string; // Android Only
  DownloadDir: string; // Android Only
  DCIMDir: string; // Android Only
  SDCardDir: string; // 0.9.5+ Android Only // Depracated
  MainBundleDir: string; // Can be used to access files embedded on iOS apps only
  LibraryDir: string;
}
